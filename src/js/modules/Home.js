...
export default class Home {
  ...
  addLinkSearch() {
    ...
    // This is hardcoded to the nabo server
    // because Netlify does not support PHP,
    // and the Opensearch XML file is generated by PHP.
    const xml = `<link
    rel="search"
    type="application/opensearchdescription+xml"
    href="https://nabo.trovu.net/src/opensearch/?${paramStr}"
    title="Trovu"
    />`;
