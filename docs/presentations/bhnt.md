# [Berlin Hack & Tell](https://bhnt.c-base.org/2024-05-28-no96-portal-hacks)

-   successor of Serchilo and FindFind.it
-   allows you to search the web as if from your command line
-   `es arbol`
-   change language
-   `es arbol`
-   `db berlin, hamburg`
...
-   [OpenSearch plugin, PWA, (Raycast)](https://trovu.net/docs/users/integration/)
